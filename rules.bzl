...
clojure_library = rule(
    ...
    attrs = {
        ...
        "deps": attr.label_list(default = [], providers = [[JavaInfo]], cfg = "target"),
        "runtime_deps": attr.label_list(default = [], providers = [[JavaInfo]], cfg = "target"),
        ...
        "compiledeps": attr.label_list(default = [], cfg = "target"),
        ...
        "_clojureworker_binary": attr.label(doc="Label for the ClojureWorker binary", default=Label("@rules_clojure//src/rules_clojure:worker"), executable = True, cfg="target"),
